...
<template>
    ...
    <div class="line m-r-type">
        ...
        <Button label="Info" color="info" icon="credit-card" outlined />
        <Button label="Warning" color="warning" icon="lemon" />
    ...
    <div class="line">
        <Button label="@click" color="danger" size="large" @click="eventForButton" />
    </div>
</template>
